...
export class MediaService {
  ...
  async createMediaItem(
    itemData: Partial<Omit<MediaItem, 'id' | 'uploadedById' | 'judicialProcessId'>>,
    url: string,
    userId: string,
