...
-- This schema is designed to be executed by the init-db.ts script.
...
CREATE TABLE IF NOT EXISTS `document_types` (
  ...
  `appliesTo` VARCHAR(50) NOT NULL COMMENT 'PHYSICAL, LEGAL, or ALL'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
-- =============================================
-- NÍVEL 7: DEPENDÊNCIAS DE NÍVEL 6
-- =============================================
...
-- =============================================
-- NÍVEL 8: TABELAS DE JUNÇÃO E DEPENDÊNCIAS FINAIS
-- =============================================
...
CREATE TABLE IF NOT EXISTS `user_lot_max_bids` (
  ...
  `createdAt` DATETIME,
  UNIQUE KEY `user_lot` (`userId`, `lotId`),
  FOREIGN KEY (`userId`) REFERENCES `users`(`id`) ON DELETE CASCADE,
  FOREIGN KEY (`lotId`) REFERENCES `lots`(`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
