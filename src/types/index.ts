...
export interface AuctionStage {
  ...
  initialPrice?: number | null; // Adicionado para lance inicial por praça
}
...
export interface UserProfileData {
  ...
  roles?: { id: string; name: string, permissions: string[] }[]; // Modified to match what service provides
}
