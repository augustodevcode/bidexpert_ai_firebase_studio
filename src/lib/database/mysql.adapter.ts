...
// It serves as a template if MySQL support is needed in the future.
...
export class MySqlAdapter implements DatabaseAdapter {
    constructor() {
        console.warn("[MySqlAdapter] DEPRECATED: This adapter is not implemented and should not be used.");
    }

    async _notImplemented(method: string, isList = false): Promise<any> {
        const message = `[MySqlAdapter] Method ${method} is not implemented.`;
