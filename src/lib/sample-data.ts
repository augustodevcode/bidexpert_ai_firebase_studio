...
export const sampleLotCategoriesStatic: Partial<Omit<LotCategory, 'id' | 'createdAt' | 'updatedAt' | 'itemCount' | 'hasSubcategories'>> & {name: string, slug: string, description: string}[] = [
  { name: 'Imóveis', slug: 'imoveis', description: 'Casas, apartamentos, terrenos, salas comerciais, galpões, fazendas, sítios e chácaras.', coverImageUrl: 'https://images.unsplash.com/photo-1560518883-ce09059eeffa?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHw0fHxyZWFsJTIwZXN0YXRlfGVufDB8fHx8MTc1MDYxMjUzNnww&ixlib=rb-4.1.0&q=80&w=1080', dataAiHintCover: 'imoveis cidade panorama' },
...
export const sampleAuctionsRaw: Omit<Auction, 'createdAt' | 'updatedAt' | 'lots' | 'totalLots' | 'category' | 'auctioneer' | 'seller' | 'auctioneerLogoUrl'>[] = [
  ...
  { id: '20301vei', publicId: 'AUC-MAQUINAS-MNO345T5', title: 'Leilão de Maquinário Pesado e Agrícola', description: 'Tratores, colheitadeiras e equipamentos industriais. Renove sua frota ou maquinário.', status: 'ABERTO_PARA_LANCES', auctionType: 'EXTRAJUDICIAL', categoryId: 'cat-maquinas-e-equipamentos', auctioneerId: 'auct-agroleiloes-ltda-matricula-xyz00', sellerId: 'seller-fazenda-boa-esperanca', auctionDate: createPastDate(3), endDate: createFutureDate(5, 0), city: 'Rio Verde', state: 'GO', imageUrl: 'https://images.unsplash.com/photo-1659021181759-2f987070b6c9?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHwxNHx8VHJhY3RvciUyMG5ldyUyMGhvbGxhbmQlMjB0N3xlbnwwfHx8fDE3NTA0MzU0NDV8MA&ixlib=rb-4.1.0&q=80&w=1080', dataAiHint: 'maquinas pesadas construcao', initialOffer: 50000, visits: 975, isFavorite: true, estimatedRevenue: 400000, marketplaceAnnouncementTitle: 'Maquinário Pesado - Grande Leilão!', allowInstallmentBids: false },
  {
    ...
    city: 'Campinas', state: 'SP', imageUrl: 'https://images.unsplash.com/photo-1737947640001-54765a2b0287?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHwxNHx8TGFwdG9wcyUyMG1hY3xlbnwwfHx8fDE3NTA0NjMxNDJ8MA&ixlib=rb-4.1.0&q=80&w=1080',
...
export const sampleLotsRaw: Omit<Lot, 'createdAt' | 'updatedAt' | 'auctionName' | 'sellerName' | 'cityName' | 'stateUf' | 'type' | 'bids' | 'reviews' | 'questions' | 'subcategoryName' | 'endDate' | 'auctionDate' | 'lotSpecificAuctionDate' | 'secondAuctionDate'>[] = [
  ...
  { id: 'LOTEART001', auctionId: 'ART001ANTIQ', publicId: 'LOT-PINTURAO-JKL012A4', title: 'Pintura a Óleo "Paisagem Toscana" - Séc. XIX', imageUrl: 'https://images.unsplash.com/photo-1703593693037-3f816218baa1?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHwxMHx8b2lsJTIwcGFpbnR1cmUlMjB0dXNjYW55fGVufDB8fHx8MTc1MDYwNTI5Mnww&ixlib=rb-4.1.0&q=80&w=1080', dataAiHint: 'pintura oleo paisagem', status: 'ABERTO_PARA_LANCES', cityId: 'city-rio-de-janeiro-rj', stateId: 'state-rj', categoryId: 'cat-arte-e-antiguidades', views: 320, price: 7500, bidsCount: 3, description: 'Belíssima pintura a óleo sobre tela, representando paisagem da Toscana. Assinatura ilegível. Moldura original.', sellerId: 'seller-colecionadores-rj', latitude: -22.9068, longitude: -43.1729, mapAddress: 'Copacabana, Rio de Janeiro - RJ', mapEmbedUrl: null, mapStaticImageUrl: `https://placehold.co/600x400.png`, allowInstallmentBids: true },
  ...
  { 
    ...
    imageUrl: 'https://images.unsplash.com/photo-1607452258545-943d7243463c?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHwxMXx8bm90ZWJvb2slMjBpbnRlbHxlbnwwfHx8fDE3NTA0NjExNzh8MA&ixlib=rb-4.1.0&q=80&w=1080', dataAiHint: 'notebook moderno tela',
