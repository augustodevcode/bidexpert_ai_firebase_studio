...
export const sampleLotCategoriesStatic: Partial<Omit<LotCategory, 'id' | 'createdAt' | 'updatedAt' | 'itemCount' | 'hasSubcategories'>> & {name: string, slug: string, description: string}[] = [
  { name: 'Imóveis', slug: 'imoveis', description: 'Casas, apartamentos, terrenos, salas comerciais, galpões, fazendas, sítios e chácaras.', coverImageMediaId: 'media-cat-imoveis-cover', logoMediaId: 'media-cat-imoveis-logo', dataAiHintCover: 'imoveis cidade panorama', dataAiHintLogo: 'predio casa' },
  { name: 'Veículos', slug: 'veiculos', description: 'Carros, motos, caminhões, ônibus, utilitários e outros veículos terrestres.', coverImageMediaId: 'media-cat-veiculos-cover', logoMediaId: 'media-cat-veiculos-logo', dataAiHintCover: 'carros patio leilao', dataAiHintLogo: 'carro moto' },
  { name: 'Máquinas e Equipamentos', slug: 'maquinas-e-equipamentos', description: 'Máquinas pesadas, agrícolas, industriais, equipamentos de construção e diversos.', coverImageMediaId: 'media-cat-maquinas-cover', logoMediaId: 'media-cat-maquinas-logo', dataAiHintCover: 'maquinas pesadas industrial', dataAiHintLogo: 'trator engrenagem' },
  { name: 'Eletrônicos e Tecnologia', slug: 'eletronicos-e-tecnologia', description: 'Celulares, computadores, notebooks, televisores, áudio, componentes e peças.', coverImageMediaId: 'media-cat-eletronicos-cover', logoMediaId: 'media-cat-eletronicos-logo' },
  { name: 'Casa e Decoração', slug: 'casa-e-decoracao', description: 'Móveis, eletrodomésticos, utensílios de cozinha, itens de decoração e iluminação.', coverImageMediaId: 'media-cat-casa-decor-cover', logoMediaId: 'media-cat-casa-decor-logo' },
  { name: 'Arte e Antiguidades', slug: 'arte-e-antiguidades', description: 'Obras de arte como pinturas e esculturas, móveis antigos e itens colecionáveis.', coverImageMediaId: 'media-cat-arte-cover', logoMediaId: 'media-cat-arte-logo' },
  { name: 'Joias e Acessórios de Luxo', slug: 'joias-e-acessorios-de-luxo', description: 'Joias, relógios de pulso e bolso, bolsas de grife, canetas e artigos de luxo.', coverImageMediaId: 'media-cat-joias-cover', logoMediaId: 'media-cat-joias-logo' },
  { name: 'Semoventes', slug: 'semoventes', description: 'Animais como bovinos, equinos, ovinos, caprinos e outros animais de produção ou estimação.', coverImageMediaId: 'media-cat-semoventes-cover', logoMediaId: 'media-cat-semoventes-logo' },
  { name: 'Materiais e Sucatas', slug: 'materiais-e-sucatas', description: 'Materiais de construção civil, sucatas metálicas, resíduos industriais e recicláveis.', coverImageMediaId: 'media-cat-sucatas-cover', logoMediaId: 'media-cat-sucatas-logo' },
  { name: 'Industrial (Geral)', slug: 'industrial-geral', description: 'Estoques industriais, matéria-prima, equipamentos de escritório (de empresas), e outros bens industriais.', coverImageMediaId: 'media-cat-industrial-cover', logoMediaId: 'media-cat-industrial-logo' },
  { name: 'Serviços e Contratos', slug: 'servicos-e-contratos', description: 'Contratação de serviços, concessões e outras oportunidades contratuais.', coverImageMediaId: 'media-cat-servicos-cover', logoMediaId: 'media-cat-servicos-logo' },
  { name: 'Outros Itens', slug: 'outros-itens', description: 'Consórcios, energia solar, direitos creditórios, itens diversos e oportunidades únicas.', coverImageMediaId: 'media-cat-outros-cover', logoMediaId: 'media-cat-outros-logo' },
];

export const sampleSubcategoriesStatic: Omit<Subcategory, 'id' | 'createdAt' | 'updatedAt' | 'itemCount' | 'slug' | 'parentCategoryName' | 'iconUrl'>[] = [
  { name: 'Apartamentos', parentCategoryId: 'cat-imoveis', description: 'Apartamentos residenciais de diversos tamanhos.', displayOrder: 1, iconMediaId: 'media-subcat-apartamentos-icon', dataAiHintIcon: 'predio apartamento' },
  { name: 'Casas', parentCategoryId: 'cat-imoveis', description: 'Casas térreas, sobrados e condomínios.', displayOrder: 2, iconMediaId: 'media-subcat-casas-icon', dataAiHintIcon: 'casa residencial' },
  { name: 'Terrenos e Lotes', parentCategoryId: 'cat-imoveis', description: 'Terrenos urbanos e rurais para construção ou investimento.', displayOrder: 3, iconMediaId: 'media-subcat-terrenos-icon', dataAiHintIcon: 'terreno mapa' },
  { name: 'Salas Comerciais', parentCategoryId: 'cat-imoveis', description: 'Espaços comerciais para escritórios e lojas.', displayOrder: 4, iconMediaId: 'media-subcat-salas-icon', dataAiHintIcon: 'edificio comercial' },
  { name: 'Carros', parentCategoryId: 'cat-veiculos', description: 'Veículos de passeio, hatch, sedan, SUV.', displayOrder: 1, iconMediaId: 'media-subcat-carros-icon', dataAiHintIcon: 'carro popular' },
  { name: 'Motos', parentCategoryId: 'cat-veiculos', description: 'Motocicletas esportivas, custom, street.', displayOrder: 2, iconMediaId: 'media-subcat-motos-icon', dataAiHintIcon: 'motocicleta esportiva' },
  { name: 'Caminhões e Ônibus', parentCategoryId: 'cat-veiculos', description: 'Veículos pesados para transporte de carga e passageiros.', displayOrder: 3, iconMediaId: 'media-subcat-caminhoes-icon', dataAiHintIcon: 'caminhao estrada' },
];
...
export const sampleSellersStatic: Omit<SellerProfileInfo, 'id'| 'publicId' | 'slug' | 'createdAt' | 'updatedAt' | 'memberSince' | 'rating' | 'activeLotsCount' | 'totalSalesValue' | 'auctionsFacilitatedCount' | 'userId' | 'logoUrl'>[] = [
    { name: 'Banco Bradesco S.A.', logoMediaId: 'media-seller-bradesco-logo', dataAiHintLogo: 'banco logo', city: 'São Paulo', state: 'SP', userId: 'consignor-example-003' },
    ...
    { name: 'Banco XYZ', city: 'Rio de Janeiro', state: 'RJ', logoMediaId: 'media-seller-xyz-logo', dataAiHintLogo: 'banco moderno' },
    { name: 'Diversos Comitentes Agro', city: 'Nacional', state: 'BR' },
    { name: 'Diversos Proprietários e Financeiras', city: 'Nacional', state: 'BR' },
    { name: 'Vara Cível de São Paulo - TJSP', city: 'São Paulo', state: 'SP', logoMediaId: 'media-seller-tjsp-logo', dataAiHint: 'justica balanca' },
    { name: 'Vara de Falências do Rio de Janeiro - TJRJ', city: 'Rio de Janeiro', state: 'RJ', logoMediaId: 'media-seller-tjrj-logo', dataAiHint: 'tribunal justica martelo' },
    { name: 'Vara do Trabalho de Curitiba - TRT9', city: 'Curitiba', state: 'PR', logoMediaId: 'media-seller-trt9-logo', dataAiHint: 'justica trabalho predio' },
    { name: 'Colecionadores Particulares', city: 'Nacional', state: 'BR' },
    { name: 'Proprietários Diversos Clássicos', city: 'Nacional', state: 'BR' },
    { name: 'Antiguidades Imperial', city: 'Rio de Janeiro', state: 'RJ', logoMediaId: 'media-seller-imperial-logo', dataAiHint: 'antigo imperial' },
    ...
    { name: 'Prefeitura Municipal de Campinas', city: 'Campinas', state: 'SP', logoMediaId: 'media-seller-pmc-logo', dataAiHint: 'prefeitura brasao' },
    { name: 'Secretaria de Administração de Salvador', city: 'Salvador', state: 'BA', logoMediaId: 'media-seller-pms-logo', dataAiHint: 'governo edificio' },
];

export const sampleAuctioneersStatic: Omit<AuctioneerProfileInfo, 'id'|'publicId'|'slug'|'createdAt'|'updatedAt'|'memberSince'|'rating'|'auctionsConductedCount'|'totalValueSold'| 'logoUrl'>[] = [
  { name: 'VICENTE PAULO - JUCEMA N° 12/96', logoMediaId: 'media-auct-vicente-logo', dataAiHintLogo: 'leiloeiro martelo', city: 'São Luís', state: 'MA'},
  { name: 'AGROLEILÕES LTDA - MATRICULA XYZ/00', logoMediaId: 'media-auct-agro-logo', dataAiHintLogo: 'auctioneer logo', city: 'Rio Verde', state: 'GO'},
  { name: 'SUPERBID Leilões - JUCESP Nº 123', logoMediaId: 'media-auct-superbid-logo', dataAiHintLogo: 'logo empresa moderno', city: 'São Paulo', state: 'SP'},
  { name: 'Bomvalor Judicial', city: 'Ribeirão Preto', state: 'SP'},
  { name: 'Galeria Antika - Leiloeiro Oficial A.Silva', logoMediaId: 'media-auct-antika-logo', dataAiHintLogo: 'auctioneer logo', city: 'São Paulo', state: 'SP'},
  { name: 'Clássicos Leilões BR - Leiloeiro J.Pimenta', logoMediaId: 'media-auct-classicos-logo', dataAiHintLogo: 'auctioneer logo', city: 'Curitiba', state: 'PR'},
  { name: 'Leiloeiro XYZ Oficial', city: 'Rio de Janeiro', state: 'RJ'},
  { name: 'Leiloeiro Oficial Bradesco', logoMediaId: 'media-auct-bradesco-logo', dataAiHintLogo: 'auctioneer logo', city: 'São Paulo', state: 'SP'},
  { name: 'Leiloeiro Público Municipal Campinas', city: 'Campinas', state: 'SP', logoMediaId: 'media-auct-pmc-logo'},
  { name: 'Central de Compras Bahia', city: 'Salvador', state: 'BA', logoMediaId: 'media-auct-ccb-logo'},
];
...
export const sampleAuctionsRaw: Omit<Auction, 'createdAt' | 'updatedAt' | 'lots' | 'totalLots' | 'category' | 'auctioneer' | 'seller' | 'auctioneerLogoUrl' | 'imageUrl'>[] = [
  ...
  { id: 'CLASSICVEH24', publicId: 'AUC-MUSTANGS-JKL012S4', title: 'Leilão Especial de Mustangs Clássicos', description: 'Modelos raros de Ford Mustang das décadas de 60 e 70. Para apaixonados por clássicos.', status: 'ABERTO_PARA_LANCES', auctionType: 'PARTICULAR', categoryId: 'cat-veiculos', auctioneerId: 'auct-classicos-leiloes-br-leiloeiro-jpimenta', sellerId: 'seller-colecionadores-classicos-pr', auctionDate: createPastDate(1), endDate: createFutureDate(12, 0), city: 'Curitiba', state: 'PR', imageMediaId: 'media-auc-mustang-banner', dataAiHint: 'mustang classico perfil', initialOffer: 150000, visits: 2100, auctionStages: [{ name: 'Pregão Único', endDate: createFutureDate(12,0), statusText: 'Encerramento Lances', initialPrice: 150000 }], allowInstallmentBids: true, estimatedRevenue: 300000, isFeaturedOnMarketplace: true },
  { id: '20301vei', publicId: 'AUC-MAQUINAS-MNO345T5', title: 'Leilão de Maquinário Pesado e Agrícola', description: 'Tratores, colheitadeiras e equipamentos industriais. Renove sua frota ou maquinário.', status: 'ABERTO_PARA_LANCES', auctionType: 'EXTRAJUDICIAL', categoryId: 'cat-maquinas-e-equipamentos', auctioneerId: 'auct-agroleiloes-ltda-matricula-xyz00', sellerId: 'seller-fazenda-boa-esperanca', auctionDate: createPastDate(3), endDate: createFutureDate(5, 0), city: 'Rio Verde', state: 'GO', imageMediaId: 'media-auc-maquinas-banner', dataAiHint: 'maquinas pesadas construcao', initialOffer: 50000, visits: 975, isFavorite: true, estimatedRevenue: 400000, marketplaceAnnouncementTitle: 'Maquinário Pesado - Grande Leilão!', allowInstallmentBids: false },
  {
    ...
    city: 'Campinas', state: 'SP', imageMediaId: 'media-auc-notebooks-banner',
  ...
  },
  {
    ...
    city: 'Salvador', state: 'BA', imageMediaId: 'media-auc-veiculosfrota-banner',
  ...
  },
  {
    ...
    imageMediaId: 'media-auc-judimv-banner',
    ...
    automaticBiddingEnabled: false, allowInstallmentBids: true, estimatedRevenue: 280000, totalHabilitatedUsers: 55, isFeaturedOnMarketplace: true, additionalTriggers: ['JUDICIAL']
  },
  {
    ...
    imageMediaId: 'media-auc-judvei-banner',
  ...
  },
  {
    ...
    imageMediaId: 'media-auc-judmaq-banner', dataAiHint: 'trator antigo vermelho',
...
export const sampleLotsRaw: Omit<Lot, 'createdAt' | 'updatedAt' | 'auctionName' | 'sellerName' | 'cityName' | 'stateUf' | 'type' | 'bids' | 'reviews' | 'questions' | 'subcategoryName' | 'endDate' | 'auctionDate' | 'lotSpecificAuctionDate' | 'secondAuctionDate' | 'imageUrl' | 'galleryImageUrls'>[] = [
  ...
  { 
    ...
    imageMediaId: 'media-lot-notebook-a-main', dataAiHint: 'notebook moderno tela',
  ...
  { 
    ...
    imageMediaId: 'media-lot-notebook-b-main', dataAiHint: 'notebook avançado aberto',
    status: 'ABERTO_PARA_LANCES', cityId: 'city-campinas-sp', stateId: 'state-sp', categoryId: 'cat-eletronicos-e-tecnologia',
  ...
  },
  {
    ...
    imageMediaId: 'media-lot-cronos-main', dataAiHint: 'carro sedan branco',
  ...
  },
  {
    ...
    imageMediaId: 'media-lot-fiorino-main', dataAiHint: 'fiorino branca carga',
  ...
  },
  {
    ...
    imageMediaId: 'media-lot-apto-moema-main', dataAiHint: 'apartamento interior moderno',
  ...
  },
  {
    ...
    imageMediaId: 'media-lot-toro-main', dataAiHint: 'fiat toro branca frente',
