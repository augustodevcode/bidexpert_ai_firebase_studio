...
import { DollarSign, BarChart3, TrendingUp, CircleDollarSign, Loader2, AlertCircle, Gavel, ListChecks } from 'lucide-react';
...
export default function ConsignorFinancialPage() {
  ...
  }, [userProfileWithPermissions, authLoading, fetchFinancials]);
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <Card>
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                  <CardTitle className="text-sm font-medium">Faturamento Bruto (Pago)</CardTitle>
          ...
          <Card>
           ...
           <Card>
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                  <CardTitle className="text-sm font-medium">Valor Líquido a Receber</CardTitle>
