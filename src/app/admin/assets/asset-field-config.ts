...
export const VEHICLE_FIELDS: AssetFieldGroup[] = [
  {
    ...
    fields: [
      ...
      { name: 'plateState', label: 'UF da Placa', type: 'text', placeholder: 'SP' },
      { name: 'plateFinal', label: 'Final da Placa', type: 'text', placeholder: '0' },
      { name: 'vin', label: 'VIN (Número de Identificação)', type: 'text', placeholder: '9BWZZZ...' },
      { name: 'chassis', label: 'Chassi', type: 'text', placeholder: 'C9BWZZZ...' },
  ...
  },
  {
    ...
    fields: [
      ...
      { name: 'engineStatus', label: 'Estado do Motor', type: 'text', placeholder: 'Ex: Funcionando, Sem Teste...' },
      { name: 'mileageStatus', label: 'Estado do Odômetro', type: 'text', placeholder: 'Ex: Digital, Analógico, Sem Bateria...' },
      { 
        name: 'bodyCondition', 
      ...
      { name: 'ipvaPaid', label: 'IPVA Pago?', type: 'boolean' },
      { name: 'documentStatus', label: 'Situação do Documento', type: 'text', placeholder: 'Ex: CRLV em mãos, Pendente...' },
