...
export default function MediaLibraryPage() {
  ...
  const confirmDeleteSingle = useCallback(async () => {
    ...
    if (result.success) {
      toast({ title: 'Exclu├¡do', description: result.message });
  ...
  const confirmBulkDelete = useCallback(async () => {
    ...
    if (result.successCount > 0) {
      toast({ title: 'Exclus├úo em Massa', description: `${result.successCount} exclu├¡do(s).` });
    }
          ...
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                Esta a├º├úo n├úo pode ser desfeita. O arquivo ser├í permanentemente removido.
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
        ...
        <AlertDialog open={bulkDeleteConfirm} onOpenChange={(v) => !v && setBulkDeleteConfirm(false)}>
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                {selectedIds.size} arquivo(s) ser├úo permanentemente removidos. Esta a├º├úo n├úo pode ser desfeita.
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
              <AlertDialogCancel>Cancelar</AlertDialogCancel>
