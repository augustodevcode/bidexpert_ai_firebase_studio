              ...
              <Tabs defaultValue="geral">
                  ...
                  <div className="space-y-4">
                      ...
                      <TabsContent value="detalhes" className="mt-0 space-y-4">
                        ...
                        {categorySlug.includes('eletronico') && <Accordion type="single" collapsible defaultValue="electronics-details"><AccordionItem value="electronics-details"><AccordionTrigger><div className="flex items-center gap-2"><ImageIcon className="h-5 w-5" /> Detalhes (Eletrônicos)</div></AccordionTrigger><AccordionContent className="space-y-4 pt-4"><div className="grid grid-cols-1 sm:grid-cols-2 gap-4"><FormField control={form.control} name="brand" render={({ field }) => <FormItem><FormLabel>Marca</FormLabel><FormControl><Input {...field} value={field.value ?? ''} /></FormControl></FormItem>} /><FormField control={form.control} name="serialNumber" render={({ field }) => <FormItem><FormLabel>Nº de Série</FormLabel><FormControl><Input {...field} value={field.value ?? ''} /></FormControl></FormItem>} /></div><FormField control={form.control} name="itemCondition" render={({ field }) => <FormItem><FormLabel>Condição</FormLabel><FormControl><Input placeholder="Ex: Novo, Usado, Com defeito..." {...field} value={field.value ?? ''} /></FormControl></FormItem>} /></AccordionContent></AccordionItem></Accordion>}
                        {categorySlug.includes('embarcacoes') && <Accordion type="single" collapsible defaultValue="boats-details"><AccordionItem value="boats-details"><AccordionTrigger><div className="flex items-center gap-2"><Anchor className="h-5 w-5" /> Detalhes (Embarcações)</div></AccordionTrigger><AccordionContent className="space-y-4 pt-4"><div className="grid grid-cols-1 sm:grid-cols-2 gap-4"><FormField control={form.control} name="boatType" render={({ field }) => <FormItem><FormLabel>Tipo</FormLabel><FormControl><Input placeholder="Lancha, Veleiro..." {...field} value={field.value ?? ''} /></FormControl></FormItem>} /><FormField control={form.control} name="boatLength" render={({ field }) => <FormItem><FormLabel>Comprimento (Pés)</FormLabel><FormControl><Input {...field} value={field.value ?? ''} /></FormControl></FormItem>} /></div><FormField control={form.control} name="hullMaterial" render={({ field }) => <FormItem><FormLabel>Material do Casco</FormLabel><FormControl><Input placeholder="Fibra de vidro, Alumínio..." {...field} value={field.value ?? ''} /></FormControl></FormItem>} /></AccordionContent></AccordionItem></Accordion>}
                        {categorySlug.includes('arte-antiguidades') && <Accordion type="single" collapsible defaultValue="art-details"><AccordionItem value="art-details"><AccordionTrigger><div className="flex items-center gap-2"><Paintbrush className="h-5 w-5" /> Detalhes (Arte/Antiguidades)</div></AccordionTrigger><AccordionContent className="space-y-4 pt-4"><div className="grid grid-cols-1 sm:grid-cols-2 gap-4"><FormField control={form.control} name="artist" render={({ field }) => <FormItem><FormLabel>Artista</FormLabel><FormControl><Input {...field} value={field.value ?? ''} /></FormControl></FormItem>} /><FormField control={form.control} name="period" render={({ field }) => <FormItem><FormLabel>Período/Época</FormLabel><FormControl><Input placeholder="Séc. XIX, Modernismo..." {...field} value={field.value ?? ''} /></FormControl></FormItem>} /></div></AccordionContent></AccordionItem></Accordion>}
                      </TabsContent>
