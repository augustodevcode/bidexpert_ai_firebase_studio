              ...
              <Tabs defaultValue="geral">
                  ...
                  <div className="space-y-4">
                      ...
                      <TabsContent value="detalhes" className="mt-0 space-y-4">
                          {/* Veículos */}
                          {categorySlug.includes('veiculo') && (<Accordion type="single" collapsible defaultValue="vehicle-id"><AccordionItem value="vehicle-id"><AccordionTrigger>Identificação</AccordionTrigger><AccordionContent className="space-y-4 pt-2">
