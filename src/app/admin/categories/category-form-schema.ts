// src/app/admin/categories/category-form-schema.ts
/**
 * @fileoverview Define o schema de validação (usando Zod) para o formulário
 * de criação e edição de Categorias de Lotes. Este schema é usado pelo
 * `react-hook-form` para garantir que os dados do formulário sejam consistentes
