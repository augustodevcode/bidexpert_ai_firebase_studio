...
import { getDocumentTemplateAction, updateDocumentTemplate, deleteDocumentTemplate } from '../actions';
...
export default function EditDocumentTemplatePage() {
  ...
  const fetchPageData = useCallback(async () => {
    ...
    setIsLoading(true);
    try {
      const fetchedTemplate = await getDocumentTemplateAction(templateId);
      if (!fetchedTemplate) {
        notFound();
        return;
      }
