                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>Comitente/Vendedor</FormLabel>
                     <Select onValueChange={field.onChange} value={field.value || ''} disabled={!!judicialProcessSellerName}>
                      <FormControl><SelectTrigger><SelectValue placeholder={!!judicialProcessSellerName ? 'Definido pelo Processo' : 'Selecione...'} /></SelectTrigger></FormControl>
                      <SelectContent>
