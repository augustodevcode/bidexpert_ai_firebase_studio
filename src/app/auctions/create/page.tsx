...
import { Loader2, Sparkles, Lightbulb, ListChecks, BarChart2 } from 'lucide-react';
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>Provide JSON data of recent successful auctions for similar items to improve AI suggestions.</FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
              />
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>A brief summary of past performance for similar items, if available.</FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
              />
      ...
      {(aiSuggestions.listingDetails || aiSuggestions.openingValue || aiSuggestions.similarListings) && !isLoading && (
        <Card className="shadow-xl mt-8">
          <CardHeader>
            ...
            <CardDescription>
              Review these suggestions to optimize your auction listing.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-6">
            {aiSuggestions.listingDetails && (
              <section>
                ...
                <div className="space-y-3 p-4 bg-secondary/30 rounded-lg">
                  ...
                  <p><strong>Predicted Opening Value:</strong> ${aiSuggestions.listingDetails.predictedOpeningValue.toLocaleString()}</p>
            ...
            {aiSuggestions.openingValue && (
              <section>
                <h3 className="text-xl font-semibold mb-2 flex items-center"><BarChart2 className="h-5 w-5 mr-2 text-primary" /> Optimal Opening Bid</h3>
                 <div className="space-y-3 p-4 bg-secondary/30 rounded-lg">
                  <p><strong>Suggested Opening Value:</strong> ${aiSuggestions.openingValue.suggestedOpeningValue.toLocaleString()}</p>
            ...
            {aiSuggestions.similarListings && aiSuggestions.similarListings.listings.length > 0 && (
              <section>
                <h3 className="text-xl font-semibold mb-2 flex items-center"><ListChecks className="h-5 w-5 mr-2 text-primary" /> Detailed Similar Listings</h3>
            ...
            <Button className="w-full mt-6">Proceed to List Auction</Button>
          </CardContent>
        </Card>
      )}
    </div>
