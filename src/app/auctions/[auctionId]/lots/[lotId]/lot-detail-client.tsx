...
export default function LotDetailClientContent({
  ...
  const displayBidAmount = parseFloat(bidAmountInput) >= nextMinimumBid
    ? parseFloat(bidAmountInput)
    : nextMinimumBid;
          ...
          <div className="lg:col-span-1 space-y-6 lg:sticky lg:top-24">
            ...
            <Card className="shadow-md">
                ...
                <CardContent className="space-y-2 text-sm">
                    ...
                    {(!lot.evaluationValue && !lot.reservePrice && !lot.debtAmount && !lot.itbiValue) && <p className="text-muted-foreground text-center text-xs py-2">Nenhuma condição de valor especial para este lote.</p>}
                </CardContent>
            </Card>
