        ...
        <div className="space-y-6"> 
            ...
            <div className="lg:col-span-2 space-y-6">
                ...
                <Tabs defaultValue="description" className="w-full">
                 ...
                 <Card className="shadow-md">
                    ...
                    <CardContent>
                        {isLoadingData ? (
                            ...
                            <ul className="space-y-2 text-sm pr-2 max-h-40 overflow-y-auto">
                 ...
                 <div className="aspect-square w-full"> {/* Map with 1:1 aspect ratio */}
...
export default function DynamicBreadcrumbs() {
  ...
  const items = useMemo(() => {
    ...
    for (let i = 0; i < pathSegments.length; i++) {
      ...
      } else if (segment === 'search' || segment === 'map-search') {
  ...
  return (
    <nav aria-label="Breadcrumb" className="bg-secondary text-secondary-foreground text-xs py-2.5 border-b"> {/* Aumentado py-2 para py-2.5 */}
