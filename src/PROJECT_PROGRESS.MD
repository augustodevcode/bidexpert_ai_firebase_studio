...
- **38.3:** Criado o Componente de Popup de Inscrição (`SubscriptionPopup.tsx`).
- **38.4:** Criado Componente de Inscrição Embarcado (`SubscriptionForm.tsx`).

## DOING
- **Item 38.5:** Integrar os componentes (`SubscriptionPopup` e `SubscriptionForm`) no layout principal da aplicação.
