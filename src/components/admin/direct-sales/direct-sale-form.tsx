// src/components/admin/direct-sales/direct-sale-form.tsx
'use client';
...
import { directSaleOfferFormSchema, type DirectSaleOfferFormData } from '@/app/admin/direct-sales/direct-sale-form-schema';
import type { DirectSaleOffer, LotCategory, SellerProfileInfo, MediaItem } from '@/types';
import { Loader2, Save, ShoppingCart, CalendarIcon, DollarSign, ImagePlus, Trash2, ImageIcon } from 'lucide-react';
...
const DirectSaleForm = React.forwardRef<any, DirectSaleFormProps>(({
  initialData,
...
DirectSaleForm.displayName = "DirectSaleForm";
