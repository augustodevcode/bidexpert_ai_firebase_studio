 ...
 * Remoção de Fundo (Canvas API magic wand — sem AGPL).
 * data-ai-id="media-image-editor"
 *
 * Licença: Todas as dependências são MIT ou Apache-2.0. Nenhuma AGPL.
 */
'use client';
...
export function MediaImageEditor({ item, open, onClose, onSave }: MediaImageEditorProps) {
  ...
  const exportCanvas = useCallback(async (mode: 'copy' | 'overwrite') => {
    ...
    try {
      ...
      toast({ title: 'Salvo', description: mode === 'copy' ? 'Cópia salva com sucesso.' : 'Imagem substituída.' });
      onClose();
    } catch (_err) {
            ...
            <Tabs defaultValue="transform" className="p-3">
                ...
                <div className="space-y-2">
                  ...
                  <div className="space-y-1">
                    <div className="flex justify-between">
                      <span className="text-[10px] text-muted-foreground">Rotação livre</span>
              ...
              <TabsContent value="adjust" className="space-y-4 mt-0">
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    <Label className="text-xs font-medium flex items-center gap-1.5">
                      <Droplets className="h-3.5 w-3.5" />Saturação
                    </Label>
          ...
          <div className="flex items-center justify-between w-full">
            ...
            <div className="flex gap-2">
              ...
              <Button
                ...
                disabled={saving}
              >
                <Save className="h-3.5 w-3.5" /> Salvar Cópia
              </Button>
              <Button
