 ...
 * Exibe info do arquivo, entity links, e campos editáveis (altText, caption, title, description).
          ...
          <div className="flex items-center justify-center h-full text-muted-foreground">
            {selectedCount > 1 ? (
              <div className="text-center space-y-2">
                ...
                <p className="text-sm text-muted-foreground">Selecione um único item para ver detalhes</p>
              </div>
            ) : (
                ...
                <div className="space-y-3">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <Input
                      ...
                      placeholder="Legenda para exibição..."
                      className="h-8 text-sm"
                    />
                  </div>
                  <div className="space-y-1.5">
                    <Label htmlFor="media-description" className="text-xs">Descrição</Label>
                    <Textarea
