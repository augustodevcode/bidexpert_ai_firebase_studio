...
export default function Header({ 
  ...
  useEffect(() => {
    ...
    probeImage.onload = () => {
      if (!isMounted) return;
      setIsLogoValid(probeImage.naturalWidth > 0 && probeImage.naturalHeight > 0);
    };
    ...
    probeImage.src = siteLogoUrl;

    return () => {
      isMounted = false;
    };
  }, [isClient, siteLogoUrl]);
