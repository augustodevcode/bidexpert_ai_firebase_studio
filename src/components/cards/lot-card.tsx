    ...
    <>
      <Card data-ai-id={`lot-card-${lot.id}`} className="card-lot">
        <div className="container-lot-image">
          ...
          <div className="absolute bottom-2 left-1/2 z-20 flex w-auto -translate-x-1/2 transform-gpu flex-row items-center justify-center space-x-1.5 opacity-0 transition-all duration-300 group-hover:-translate-y-0 group-hover:opacity-100 translate-y-4">
            <TooltipProvider>
