// components/BidReportBuilder/components/PainelVariaveis.jsx
'use client';
...
const VariavelArrastavel = ({ name, value }) => {
                        ...
                        <AccordionItem value={group.group} key={group.group} data-ai-id={`variable-group-${group.group.toLowerCase()}`}>
                            ...
                            <AccordionContent className="space-y-2">
                                {group.items.map(item => (
                                    <VariavelArrastavel key={item.value} name={item.name} value={item.value} />
                                ))}
                            </AccordionContent>
                        </AccordionItem>
                    ))}
...
export default PainelVariaveis;
