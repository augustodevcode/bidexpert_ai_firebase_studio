// components/BidReportBuilder/components/PropertiesPanel.tsx
'use client';
...
interface PropertiesPanelProps {
  ...
  onElementChange: (id: string, newProps: Partial<Element>) => void;
}

// Panel that displays and edits the properties of a selected element.
const PropertiesPanel: React.FC<PropertiesPanelProps> = ({ selectedElement, onElementChange }) => {
  ...
  const handleChange = (prop: keyof Element, value: string) => {
    // For numeric inputs, ensure the value is a number
  ...
  return (
    <div className="p-4 space-y-4" data-ai-id="report-properties-panel">
