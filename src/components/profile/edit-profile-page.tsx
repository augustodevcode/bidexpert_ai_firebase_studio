/**
 * @fileoverview Componente de edição do perfil do usuário no painel administrativo.
 * Encapsula a lógica de carregamento e submissão do formulário para reutilização
 * em rotas administrativas e redirecionamentos legados.
 */
'use client';
