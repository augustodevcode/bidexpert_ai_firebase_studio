...
- Todo PR deve incluir prints/screenshot(s) de sucesso dos testes Playwright.
- Todo PR deve incluir link do relatório de execução (Playwright/Vitest UI) e cenário validado.
- PR sem evidência visual de sucesso dos testes não deve ser aprovado nem mergeado.
