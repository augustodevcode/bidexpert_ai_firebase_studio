...
*   **3.1.5. Considerações sobre TDD:**
    ...
    *   **Testes End-to-End (E2E):**
        ...
        *   Adicionar cenários E2E para login com credenciais inválidas e verificar as mensagens de erro na UI.
...
*   **3.4.2. Cenários BDD (Gherkin):**
    ...
    Feature: Gerenciamento de Lotes
      ...
      Scenario: Contador de lances (`Lot.bidsCount`) é atualizado após um lance
        Given O lote "LOTE001" está "ABERTO_PARA_LANCES" e tem 0 lances (`bidsCount: 0`)
...
*   **3.11.6. Considerações sobre TDD:**
    ...
    *   **Testes de Integração (Server Actions - a serem criadas):**
        ...
        *   `getConsignorFinancialReport(consignorUserId: string, reportParams: any)`: Gerar dados de relatório.
