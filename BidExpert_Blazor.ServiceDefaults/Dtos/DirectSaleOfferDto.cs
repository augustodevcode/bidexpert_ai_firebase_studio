...
public record DirectSaleOfferDto
{
    ...
    public decimal? Price { get; init; } // Changed from number to decimal for currency
    public decimal? MinimumOfferPrice { get; init; } // Changed from number to decimal for currency
